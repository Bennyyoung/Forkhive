 ...
 return (
  <table>
   ...
   <tr style={{ marginTop: '-20px' }}>
    ...
    <td style={{ color: 'grey', fontWeight: 'bold' }}>18,000/yr </td>
   </tr>
   <hr />

   <tr style={{ marginTop: '-20px' }}>
    <td>Development time</td>
    <td style={{ color: 'grey', fontWeight: 'bold' }}>35,000 </td>
   </tr>
   <hr />
...
export default SilverPlanServices