const techStack = [
    // Development
    {
        img: 'https://img.icons8.com/color/48/gatsbyjs.png',
        text: 'GATSBY',
    ...
    {
        img: 'https://img.icons8.com/fluency/48/vite.png',
        text: 'VITE',
    ...
    // Data Science
    {
        img: 'https://img.icons8.com/color/48/000000/tableau-software.png',
        text: 'TABLEAU',
