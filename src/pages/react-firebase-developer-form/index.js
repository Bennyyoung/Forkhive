...
const ReactFirebaseDeveloperForm = props => (
 <Layout bodyClass="page-react-firebase-developer-form">
  <SEO title="React Firebase Developer Form" />
  ...
  <div className="container">
   ...
   <div style={{ margin: "0", paddingBottom: '80px' }}>
    ...
    >
     ...
     <p type="LinkedIn URL">
      <input type="text" placeholder="https://example.com" required name="LinkedIn URL" pattern="^(https?://)?([a-zA-Z0-9]([a-zA-ZäöüÄÖÜ0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6}$"></input>
     </p>
     <p type="Twitter URL">
      <input type="text" placeholder="https://example.com" required name="Twitter URL" pattern="^(https?://)?([a-zA-Z0-9]([a-zA-ZäöüÄÖÜ0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6}$"></input>
     </p>
     <p type="GitHub URL">
      <input type="text" placeholder="https://example.com" required name="GitHub URL" pattern="^(https?://)?([a-zA-Z0-9]([a-zA-ZäöüÄÖÜ0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6}$"></input>
     </p>
     <p type="Portfolio URL">
      <input type="text" placeholder="https://example.com" required name="Portfolio URL" pattern="^(https?://)?([a-zA-Z0-9]([a-zA-ZäöüÄÖÜ0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6}$"></input>
     </p>
...
export default ReactFirebaseDeveloperForm;
